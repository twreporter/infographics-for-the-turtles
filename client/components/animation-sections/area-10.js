    ...
    return (
      <div className={style.area10}>
        <div className={style.container}>
          ...
          <p className={style.link}><a href="https://www.twreporter.org/a/marine-debris-seaturtle-tomb" target='_blank' ><img src={img} role="presentation" /><span>失控的海洋廢棄物——塑膠砌成的海龜墳場</span></a></p>
          <p className={style.link}><a href="https://www.twreporter.org/a/taiwan-ocean-waste" target='_blank'><img src={img} role="presentation" /><span>無所不在的海洋微塑膠入侵記</span></a></p>
        </div>
      </div>
    )
  }
